...
class _ExamPreviewScreenState extends State<ExamPreviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = (_currentQuestionIndex + 1) / _shuffledExam.questions.length;
          ...
          actions: [
            if (_isPublishing)
              ...
              TextButton.icon(
                ...
                label: const Text('نشر إلى Supabase', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        ...
        body: Column(
          children: [
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('هذه معاينة فقط. لن يتم حفظ الدرجات.', style: TextStyle(color: Colors.orange, fontSize: 12)),
                ],
              ),
            ),
            LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(category?.color ?? AppColors.primary),
              minHeight: 6,
            ),
            Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    if (currentQuestion.passage != null) ...[
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: (category?.color ?? AppColors.primary).withOpacity(0.1)),
                        ),
                        child: Text(
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.mutedColor(context)),
                    ),
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected 
                                  ? (category?.color ?? AppColors.primary).withOpacity(0.1)
                                  : isCorrect ? Colors.green.withOpacity(0.05) : AppColors.surface(context),
                              borderRadius: AppTokens.radiusLgAll,
                              border: Border.all(
                                color: isSelected 
                            ...
                            child: Row(
                              children: [
                                Icon(
                                  ...
                                  color: isSelected ? (category?.color ?? AppColors.primary) : AppColors.mutedColor(context),
                                ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  if (_currentQuestionIndex > 0) const SizedBox(width: AppTokens.spacing16),
                  Expanded(
                    flex: 2,
                    child: ElevatedButton(
                      onPressed: () {
                        if (_currentQuestionIndex < _shuffledExam.questions.length - 1) {
                      ...
                      child: Text(_currentQuestionIndex < _shuffledExam.questions.length - 1 ? 'التالي' : 'نهاية المعاينة'),
                    ),
                  ),
                ],
              ),

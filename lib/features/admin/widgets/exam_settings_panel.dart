...
class ExamSettingsPanel extends StatelessWidget {
  ...
  Widget _buildLevelField(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildFieldLabel('مستوى الامتحان', context),
        DropdownButtonFormField<int>(
          initialValue: selectedLevel,
          decoration: _inputDecoration('اختر المستوى', Icons.signal_cellular_alt_rounded, context),
          dropdownColor: isDark ? AppColors.bgDark : Colors.white,
          isExpanded: true,
          items: ExamLevel.values
              .map(

...
class QuestionListPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final animDuration = potato.animationsEnabled
        ...
        : Duration.zero;
    final state = context.watch<ExamEditorState>();
    final hidePoints = state.hidePoints;
    return Container(
          ...
          Expanded(
            child: questions.isEmpty
                ...
                : onReorderQuestions != null
                    ? _buildReorderableList(hidePoints, animDuration)
                    : _buildRegularList(hidePoints, animDuration),
          ),
        ],
      ),
    );
  ...
  Widget _buildReorderableList(bool hidePoints, [Duration animDuration = AppTokens.durationMd]) {
    return ReorderableListView.builder(
      ...
      itemBuilder: (context, index) {
        if (index == questions.length) {
          if (isMobile) return const SizedBox.shrink(key: ValueKey('add_question_button'));
          return Padding(
  ...
  Widget _buildRegularList(bool hidePoints, [Duration animDuration = AppTokens.durationMd]) {

...
class ExamEditorState extends ChangeNotifier {
  ...
  factory ExamEditorState.fromExam(Exam exam, {bool hidePoints = false, bool hideTimer = false, bool hideLevel = false}) {
    ...
    return ExamEditorState(
      ...
      selectedLevel: exam.level,
      durationMinutes: exam.durationMinutes ?? 30,
      durationEnabled: hideTimer ? false : (exam.durationMinutes != null),
      ...
      passages: [],
      passageCache: {},
      defaultPoints: hidePoints ? 0 : (exam.questions.isNotEmpty ? exam.questions.first.points : 10),
  ...
  factory ExamEditorState.empty({TeacherExamDefaults? defaults, bool hidePoints = false, bool hideTimer = false, bool hideLevel = false}) {
    ...
    return ExamEditorState(
      ...
      durationEnabled: hideTimer ? false : d.defaultDurationEnabled,
      questions: [],
      questionSettings: [],
      isPublished: false,
      currentQuestionIndex: -1,
      ...
      passages: [],
      passageCache: {},
      defaultPoints: hidePoints ? 0 : d.defaultPoints,
      hidePoints: hidePoints,
      hideTimer: hideTimer,
      hideLevel: hideLevel,
    );
  ...
  void setSelectedGrade(int value) {
    selectedGrade = value;
    notifyListeners();
  }
  ...
  void setDurationEnabled(bool value) {
